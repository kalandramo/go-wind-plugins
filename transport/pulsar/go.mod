module github.com/tx7do/go-wind-plugins/transport/pulsar

go 1.26.3

replace (
	github.com/tx7do/go-wind-plugins/broker => ../../broker
	github.com/tx7do/go-wind-plugins/broker/pulsar => ../../broker/pulsar
...
require (
	...
	github.com/tx7do/go-wind-plugins/broker/pulsar v0.0.1
