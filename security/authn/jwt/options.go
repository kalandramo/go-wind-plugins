...
type Options struct {
	...
	signingKey    interface{}   // key for signing tokens (private key for asymmetric algorithms)
	keyFunc       jwtV5.Keyfunc // function to retrieve key for verifying tokens (public key for asymmetric algorithms)
}
