module github.com/tx7do/go-wind-plugins/transport/rabbitmq

go 1.26.3

replace (
	github.com/tx7do/go-wind-plugins/broker => ../../broker
	github.com/tx7do/go-wind-plugins/broker/rabbitmq => ../../broker/rabbitmq
...
require (
	...
	github.com/tx7do/go-wind-plugins/broker/rabbitmq v0.0.1
