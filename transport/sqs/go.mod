module github.com/tx7do/go-wind-plugins/transport/sqs

go 1.26.3

replace (
	github.com/tx7do/go-wind-plugins/broker => ../../broker
	github.com/tx7do/go-wind-plugins/broker/sqs => ../../broker/sqs
...
require (
	...
	github.com/tx7do/go-wind-plugins/broker/sqs v0.0.1
