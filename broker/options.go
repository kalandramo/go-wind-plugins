...
import (
	...
	_ "github.com/tx7do/go-wind-plugins/encoding/proto"
...
func WithTracerProvider(provider trace.TracerProvider) Option {
	return func(o *Options) {
		...
		o.Tracings = append(o.Tracings, otlp.WithTracerProvider(provider))
	}
}
...
func WithPropagator(propagator propagation.TextMapPropagator) Option {
	return func(o *Options) {
		...
		o.Tracings = append(o.Tracings, otlp.WithPropagator(propagator))
	}
}
...
func WithGlobalTracerProvider() Option {
	return func(o *Options) {
		...
		o.Tracings = append(o.Tracings, otlp.WithTracerProvider(nil))
	}
}
...
func WithGlobalPropagator() Option {
	return func(o *Options) {
		...
		o.Tracings = append(o.Tracings, otlp.WithPropagator(nil))
	}
}
