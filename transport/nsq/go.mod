module github.com/tx7do/go-wind-plugins/transport/nsq

go 1.26.3

replace (
	github.com/tx7do/go-wind-plugins/broker => ../../broker
	github.com/tx7do/go-wind-plugins/broker/nsq => ../../broker/nsq
...
require (
	...
	github.com/tx7do/go-wind-plugins/broker/nsq v0.0.1
