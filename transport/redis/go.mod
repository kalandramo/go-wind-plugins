module github.com/tx7do/go-wind-plugins/transport/redis

go 1.26.3

replace (
	github.com/tx7do/go-wind-plugins/broker => ../../broker
	github.com/tx7do/go-wind-plugins/broker/redis => ../../broker/redis
...
require (
	...
	github.com/tx7do/go-wind-plugins/broker/redis v0.0.1
